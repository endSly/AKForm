...
/**
 * The styles of a `CSFormCellTextField`.
 */
...
/**
 *  The modes of a `CSFormCellTextField`.
 */
...
@class CSFormCellTextField;

/**
 *  An object conforming to the `CSFormCellTextFieldStyleProvider` protocol may provide
 *  custom styling for a `CSFormCellTextField` by implementing some or all of it's 
 *  methods.
 */
 ...
 */
- (CSFormCellTextFieldStyle)styleForTextFieldCell:(CSFormCellTextField *)cell;
 ...
 */
- (CGFloat)labelWidthForTextFieldCell:(CSFormCellTextField *)cell;
 ...
 */
- (CGFloat)heightForTextFieldCell:(CSFormCellTextField *)cell;
 ...
 */
- (UIFont *)textFieldCell:(CSFormCellTextField *)cell
 ...
 */
- (UIColor *)textFieldCell:(CSFormCellTextField *)cell
 ...
 */
@interface CSFormCellTextField : CSFormCell <UITextFieldDelegate>
