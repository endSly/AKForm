 ...
 */
@interface CSFormField : NSObject <CSFormCellValueDelegate>
 ...
 *  @see CSFormValue
 */
@property(nonatomic, strong) CSFormValue *value;
 ...
 *  @see CSMetadataCollection
 */
@property(nonatomic, strong) CSMetadataCollection *metadataCollection;
