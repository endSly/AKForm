...
@implementation CSFormFieldText
...
{
    CSFormCellTextField *cell = [tableView dequeueReusableCellWithIdentifier:CELL_IDENTIFIER_TEXTFIELD];
    if (!cell) {
        cell = [[CSFormCellTextField alloc] initWithStyleProvider:self.styleProvider];
    }
