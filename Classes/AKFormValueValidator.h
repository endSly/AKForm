...
typedef NS_ENUM(NSInteger, AKFormValueValidatorType) {
    AKFormValueValidatorTypeDestructive,
    AKFormValueValidatorTypeWarning,
    AKFormValueValidatorTypeInformative
};
...
#define DEFAULT_VALIDATOR_TYPE          AKFormValueValidatorTypeDestructive
 ...
 */
@interface AKFormValueValidator : NSObject
...
@property(nonatomic, assign) AKFormValueValidatorType type;
/**
 ...
 *
 *  @return A `AKFormValueValidator` object with the provided parameters
 */
