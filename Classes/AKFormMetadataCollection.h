...
/**  Creates and returns a metadata collection using the provided arrays.
 ...
 Each array should contain dictionaries representing `AKFormMetadata` objects (as described
 ...
 Note that to be considered valid, each of these arrays should have `AKFormMetadata`s with
...
//remember to mention 'valid metadata' and that its defined by a valid AKFormMetadata object
